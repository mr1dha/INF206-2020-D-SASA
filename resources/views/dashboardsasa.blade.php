...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> sasa@gmail.com</li>
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Kangkungs</a></li>
                            <li><a href="#">Tomat</a></li>
                            <li><a href="#">Saledri</a></li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Alamat  : Peunayong </li>
                            <li>Kontak  : 082315821616 </li>
                            <li>Email   : sasa@gmail.com</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-1">
                    <div class="footer__widget">
                        ...
                        <ul>
                            ...
                            <li><a href="#"> Informasi Penjualan </a></li>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="footer__widget">
                        <h6>Berlangganan dengan kami </h6>
                        <p> Dapatkan penawaran terbaik yang akan dikirim ke email kamu </p>
                        <form action="#">
