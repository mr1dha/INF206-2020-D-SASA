        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="#">
                                ...
                                <button type="submit" class="site-btn bg-gradient-success">SEARCH</button>
                            </form>
                        </div>
                    ...
                    <div class="hero__item bg-gradient-success" data-setbg="asset/img/hero/banner.jpg">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="footer__widget">
                        ...
                        <form action="#">
                            ...
                            <button type="submit" class="site-btn bg-gradient-success">Subscribe</button>
                        </form>
