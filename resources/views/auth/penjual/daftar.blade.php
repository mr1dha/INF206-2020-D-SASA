...
<div class="container" id="container-daftar">
  <div class="row">
    <div class="col-lg-5 kolom-1">
        ...
        <div class="form-group shadow">
          ...
          <div class="form-group shadow mt-3">
            <div class="input-group input-group-alternative">
              ...
              <textarea class="form-control form-control-alternative" placeholder="Alamat Lengkap" type="text" name="alamat_pasar" required></textarea>
            </div>
              @error('alamat_pasar')
                  <span class="text-danger" role="alert">
                      <small>{{ $message }}</small>
      ...
      <span class="text-muted">Sudah punya akun? Login <a href="{{url('/penjual/login')}}">di sini</a></span>
      </div>
    <div class="col-lg-7 kolom-2">
      <img src="{{url('assets/pic/daftar.png')}}" alt="gambar-daftar" class="img-fluid">
      <p class="lead text-muted">Ayo bermitra bersama <span>SASA</span> dan wujudkan usaha <span>SUKSES
      <hr>
    </div>
  </div>
</div>
